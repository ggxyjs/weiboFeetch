...
public class ShowIreNewsServlet extends HttpServlet 
{
		...
		throws ServletException, IOException 
	{
		...
		try
		{
			...
			News[] news= News.getNewsByTid(News.getTrackId1(topicId),page);
			...
			int tPage= News.getTotalPage(News.getTrackId1(topicId));
			...
			if(tPage>10){
				...
				if(page>1){
					...
					"onclick=\"ShowIreNews('"+(page-1)+"')\">上一页&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</a></span>\n";
				...
				for(int i=(cPage-1)*10+1;i<=cPage*10&&i<=fPage;i++){
					if(i==page){
						result+="<span><a href='javascript:void(0)' " +
						"onclick=\"ShowIreNews('"+i+"')\">"+i+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</a></span>";
					}else{
						result+="<span><a href='javascript:void(0)' " +
						"onclick=\"ShowIreNews('"+i+"')\">"+i+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</a></span>";
					}
				...
				if(fPage>cPage*10){
					...
					"onclick=\"ShowIreNews('"+fPage+"')\">"+fPage+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp</a></span>\n";
			
				}
				
				if(fPage>page){
					result+="<span><a href='javascript:void(0)' " +
					"onclick=\"ShowIreNews('"+(page+1)+"')\">下一页</a></span>\n";
				}
				result+="</div>";	
			}
