...
public class SegTag {
	...
	public SegTag(int segPathCount) {
		...
		coreDict = new Dictionary("D:\\apache-tomcat-6.0.33\\webapps\\weiboFetch\\Data\\coreDict.dct");

		bigramDict = new Dictionary("D:\\apache-tomcat-6.0.33\\webapps\\weiboFetch\\Data\\bigramDict.dct");
		personTagger = new PosTagger(Utility.TAG_TYPE.TT_PERSON, "D:\\apache-tomcat-6.0.33\\webapps\\weiboFetch\\Data\\nr", coreDict);
		transPersonTagger = new PosTagger(Utility.TAG_TYPE.TT_TRANS_PERSON, "D:\\apache-tomcat-6.0.33\\webapps\\weiboFetch\\Data\\tr", coreDict);
		placeTagger = new PosTagger(Utility.TAG_TYPE.TT_TRANS_PERSON, "D:\\apache-tomcat-6.0.33\\webapps\\weiboFetch\\Data\\ns", coreDict);
		lexTagger = new PosTagger(Utility.TAG_TYPE.TT_NORMAL, "D:\\apache-tomcat-6.0.33\\webapps\\weiboFetch\\Data\\lexical", coreDict);
	}
