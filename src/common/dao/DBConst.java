...
public class DBConst 
{
    ...
    // 数据库的主机，定义为常量HOST
    public static final String HOST = "localhost";//"121.199.38.98";
    // 数据库的端口，定义为常量PORT
    public static final String PORT = "3306";
    // 数据库的名称，定义为常量DATABASE
    public static final String DATABASE = "nuaacempss";//"comproperty";
//    public static final String DATABASE = "fidsstest";
    ...
    public static final String USERNAME = "root";//"xzw";
    // 数据库的密码，定义为常量PASSWORD
    public static final String PASSWORD = "root";//"Gt771130";
}